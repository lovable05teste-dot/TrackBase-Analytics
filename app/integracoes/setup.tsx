...
import {ArrowLeft,Check,Copy,FileText,Megaphone,Radio} from "lucide-react";
...
<div className="mb-7 flex items-center gap-3"><div className="grid size-11 place-items-center rounded-xl bg-violet-600"><Radio/></div><div><h1 className="text-2xl font-semibold">Integrações</h1><p className="text-slate-500">Contas de anúncios e parâmetros de rastreamento</p></div></div>
