    ...
    <AppShell title="Gateways" subtitle="Credenciais de webhook e últimos pedidos por gateway.">
      <div className="grid gap-4">
        <div className="metric-card rounded-xl p-5">
          <div className="flex items-center justify-between"><b>Credenciais ativas ({creds.length})</b><a href="/integracoes#gateways" className="rounded-lg border border-white/10 px-3 py-2 text-sm hover:bg-white/5">+ Nova credencial</a></div>
