  ...
  <div className="rounded-2xl border border-white/10 bg-[#101521] p-6 shadow-[0_16px_60px_#0006] sm:p-8">
   ...
   <form onSubmit={submit} className="mt-5 space-y-4">
    ...
    <div className="flex items-center justify-between text-sm"><label className="flex cursor-pointer items-center gap-2 text-slate-400"><input type="checkbox" checked={remember} onChange={e=>setRemember(e.target.checked)} className="size-4 accent-red-600"/>Manter conectado</label><a href="/docs/faq" className="text-slate-400 hover:text-slate-200">Precisa de ajuda?</a></div>
         {mode==="login"&&!need2fa&&<div className="flex items-center justify-between gap-2 text-sm"><a href="/recuperar" className="text-slate-400 hover:text-slate-200">Esqueci a senha</a><a href="/recuperar" className="text-slate-500 hover:text-slate-300">Entrava com Google? Defina uma senha</a></div>}
    ...
    <div className="mt-4">
  <a href="/docs" className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-white/10 px-4 text-sm text-slate-400 hover:bg-white/5 hover:text-slate-200">Ver como funciona</a>
</div>
   </form>
