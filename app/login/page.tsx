...
export default function Login(){
 ...
 <section className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between lg:p-12">
  ...
  <div className="relative">
   <div className="flex items-center gap-3"><img src="/trackbase-logo.png" alt="Logo TrackBase Analytics" className="h-11 w-20 object-contain"/><div><b className="block text-[15px] leading-tight">TrackBase Analytics</b><small className="block text-xs text-slate-500">Meta Ads Intelligence</small></div></div>
 ...
 <section className="flex items-center justify-center border-t border-white/10 bg-[#0b0e17] p-5 sm:p-10 lg:border-l lg:border-t-0"><div className="w-full max-w-md">
  <div className="mb-6 lg:hidden"><div className="flex items-center gap-3"><img src="/trackbase-logo.png" alt="Logo TrackBase Analytics" className="h-10 w-20 object-contain"/><div><b className="block text-[15px]">TrackBase Analytics</b><small className="block text-xs text-slate-500">Meta Ads Intelligence</small></div></div>
